  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:3001/user/updateinfo/${user._id}`,
        {
          method: "PUT",
        ...
        >
          <div className="mb-4">
            ...
            <input
              ...
              className="text-black border border-gray-300 p-2 rounded-md w-full focus:border-gray-500"
            />
          </div>
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2">
          ...
          <button
            type="submit"
            className="bg-[#AD343E] hover:bg-red-700 text-white py-2 px-4 rounded-md border border-gray-300"
          >
            Update
          </button>
        </form>
