...
//           <button className="bg-[#AD343E] text-white px-14 rounded-md cursor-pointer mr-20  ml-20  py-3.5 items-center" onClick={() => {
      ...
      <div className="flex items-center justify-center h-screen relative ">
        ...
        <div className="absolute text-center text-[#000000] mt-28">
          ...
          <div className="flex text-[#000000] justify-center">
            {/* <input className="mr-2 ml-20 bg-gray-200 rounded-md px-14 py-3.5 focus:border-gray-900" style={{ borderRadius: "12px" }} placeholder="Enter your delivery location"/> */}
            <button
